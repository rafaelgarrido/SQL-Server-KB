...
where destination_database_name = 'documentsmanager'
order by restore_date desc
-- Restore_Type: D = Database, L = Log 
...
SET @dbname = 'DocumentsManager' --substitute for whatever database name you want
